                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New text</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/text/store" class="form-horizontal">
                                    {{ csrf_field() }}

    										<div class="form-group">
                                        <label for="title_id" class="col-md-4 control-label">title_id: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" name="title_id" type="text" id="title_id" value="{{old('title_id')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" name="image" type="text" id="image" value="{{old('image')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        <label for="ip" class="col-md-4 control-label">ip: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" name="ip" type="text" id="ip" value="{{old('ip')}}">
                                        </div>
                                    </div>
