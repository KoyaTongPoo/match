                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New popular_score</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/popular_score/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" name="score" type="text" id="score" value="{{old('score')}}">
                                        </div>
                                    </div>
