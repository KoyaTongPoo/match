                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <form method="POST" action="/question/{{ $question->id }}" class="form-horizontal">
                                        ...
                                        <div class="col-md-6">{{$question->id}}</div>
                                    </div>
										<div class="form-group">
                                            <label for="from_user" class="col-md-4 control-label">from_user: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="from_user" type="text" id="from_user" value="{{$question->from_user}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="to_user" class="col-md-4 control-label">to_user: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" name="to_user" type="text" id="to_user" value="{{$question->to_user}}">
                                            </div>
                                        </div>
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="answer" type="text" id="answer" value="{{$question->answer}}">
                                            </div>
                                        </div>
