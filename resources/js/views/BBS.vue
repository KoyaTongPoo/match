...
<v-card
  ...
  >
    <v-card-title>
      ...
      v-text="message.from_user"></span>
    </v-card-title>

    <v-card-text class="headline font-weight-bold"
    v-text="message.message"></v-card-text>
...
<v-spacer></v-spacer>
  ...
  <v-card
    class="mx-auto mb-1"
    style="background: linear-gradient(-135deg, #E29BEF,#E561D6);"
    dark
    max-width="400"
  >
    <v-card-title>
      ...
      <span class="title font-weight-light">バーナデット</span>
    </v-card-title>
